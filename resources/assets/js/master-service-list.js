...
$(function () {
  ...
  if (dt_table.length) {
    var dt = dt_table.DataTable({
      ...
      buttons: [
        {
          text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add New Service</span>',
  ...
  dt.on('click', '.edit-record', function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $('#editForm').attr('action', '/master/service/' + response.id);
  ...
  // Delete Record
  $('.datatables-services tbody').on('click', '.delete-record', function () {
