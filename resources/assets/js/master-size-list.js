...
$(function () {
  ...
  if (dt_table.length) {
    var dt = dt_table.DataTable({
      ...
      buttons: [
        {
          text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add New Size</span>',
  ...
  dt_table.on('click', '.edit-record', function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $('#editForm').attr('action', '/master/size/' + response.id);
  ...
  // Delete Record
  $('.datatables-sizes tbody').on('click', '.delete-record', function () {
    // dt_user.row($(this).parents('tr')).remove().draw();
    var id = $(this).data('id');
    var code = $(this).data('code');
    if (confirm('Are you sure you want to delete size ' + code + ' ?')) {
