...
@section('page-script')
<script src="{{asset('assets/js/master-brand-list.js')}}"></script>
@endsection
...
<div class="card">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddBrand" aria-labelledby="offcanvasAddBrandLabel">
    ...
    <div class="offcanvas-body mx-0 flex-grow-0">
      <form class="add-new-brand pt-0" id="addNewBrandForm" onsubmit="return false" action="{{ route('add-brand') }}" method="POST">
        @csrf
        <div class="mb-3">
          <label class="form-label" for="add-brand-name">Name</label>
          <input type="text" class="form-control" id="add-brand-username" placeholder="name" name="name" aria-label="name" />
        </div>
        <div class="mb-3">
